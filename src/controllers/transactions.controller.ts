...
export class TransactionsController {
  ...
  index = async (req:QueryRequest< IndexTransactionsDTO>,
     res: Response,
      next: NextFunction,
    ) => {
    try {
  ...
  getDashboard = async (req:QueryRequest< GetDashboardDTO>,
    res: Response,
     next: NextFunction,
   ) => {
   try {
 ...
 getFinancialEvolution = async (req:QueryRequest< GetFinancialEvolutionDTO>,
  res: Response,
   next: NextFunction,
 ) => {
 try {
